...
namespace UPM_IPS.MDFSJPGVSProyectoIPS
{
	...
	/// </summary>
	internal partial class MDFSJPGVSProyectoIPSExplorer : MDFSJPGVSProyectoIPSExplorerBase
	{
		/// <summary>
		/// Constructs a new MDFSJPGVSProyectoIPSExplorer.
		/// </summary>
		public MDFSJPGVSProyectoIPSExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the MDFSJPGVSProyectoIPSExplorerToolWindow.
	/// </summary>
	internal abstract class MDFSJPGVSProyectoIPSExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new MDFSJPGVSProyectoIPSExplorerBase.
		/// </summary>
		protected MDFSJPGVSProyectoIPSExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.MDFSJPGVSProyectoIPSExplorerMenu;
			}
		}
		...
		{
			get { return global::UPM_IPS.MDFSJPGVSProyectoIPS.TapizDiagramaClases.DomainClassId; }
		}
