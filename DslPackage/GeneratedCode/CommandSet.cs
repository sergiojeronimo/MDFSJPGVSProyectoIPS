...
namespace UPM_IPS.MDFSJPGVSProyectoIPS
{
	...
	/// </summary>
	internal partial class MDFSJPGVSProyectoIPSCommandSet : MDFSJPGVSProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new MDFSJPGVSProyectoIPSCommandSet.
		/// </summary>
		public MDFSJPGVSProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MDFSJPGVSProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MDFSJPGVSProyectoIPSCommandSetBase.
		/// </summary>
		protected MDFSJPGVSProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMDFSJPGVSProyectoIPSExplorerCommand,
				typeof(MDFSJPGVSProyectoIPSEditorFactory).GUID);
		...
		{
			MDFSJPGVSProyectoIPSExplorerToolWindow explorer = this.MDFSJPGVSProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MDFSJPGVSProyectoIPSDocData CurrentMDFSJPGVSProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MDFSJPGVSProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MDFSJPGVSProyectoIPSDocView CurrentMDFSJPGVSProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MDFSJPGVSProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected MDFSJPGVSProyectoIPSExplorerToolWindow MDFSJPGVSProyectoIPSExplorerToolWindow
		{
			get
			{
				MDFSJPGVSProyectoIPSExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MDFSJPGVSProyectoIPSExplorerToolWindow), true) as MDFSJPGVSProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MDFSJPGVSProyectoIPSExplorerToolWindow explorerWindow = this.MDFSJPGVSProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MDFSJPGVSProyectoIPSClipboardCommandSet : MDFSJPGVSProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MDFSJPGVSProyectoIPSClipboardCommandSet.
		/// </summary>
		public MDFSJPGVSProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MDFSJPGVSProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MDFSJPGVSProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected MDFSJPGVSProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
