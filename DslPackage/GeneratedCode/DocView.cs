...
namespace UPM_IPS.MDFSJPGVSProyectoIPS
{
	...
	/// </summary>
	internal partial class MDFSJPGVSProyectoIPSDocView : MDFSJPGVSProyectoIPSDocViewBase
	{
		/// <summary>
		/// Constructs a new MDFSJPGVSProyectoIPSDocView.
		/// </summary>
		public MDFSJPGVSProyectoIPSDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class MDFSJPGVSProyectoIPSDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new MDFSJPGVSProyectoIPSDocView.
		/// </summary>
		protected MDFSJPGVSProyectoIPSDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			MDFSJPGVSProyectoIPSDocDataBase docData = this.DocData as MDFSJPGVSProyectoIPSDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for MDFSJPGVSProyectoIPSDocViewBase should be an MDFSJPGVSProyectoIPSDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.MDFSJPGVSProyectoIPS.MDFSJPGVSProyectoIPSDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.MDFSJPGVSProyectoIPS.MDFSJPGVSProyectoIPSDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.MDFSJPGVSProyectoIPS.MDFSJPGVSProyectoIPSToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.MDFSJPGVSProyectoIPS.MDFSJPGVSProyectoIPSToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.MDFSJPGVSProyectoIPSDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.MDFSJPGVSProyectoIPS.MDFSJPGVSProyectoIPSHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.MDFSJPGVSProyectoIPS.MDFSJPGVSProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.MDFSJPGVSProyectoIPS.MDFSJPGVSProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
