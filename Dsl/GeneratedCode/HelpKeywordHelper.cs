...
namespace UPM_IPS.MDFSJPGVSProyectoIPS
{
	...
	/// </remarks>
	public partial class MDFSJPGVSProyectoIPSHelpKeywordHelper : MDFSJPGVSProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MDFSJPGVSProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected MDFSJPGVSProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MDFSJPGVSProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static MDFSJPGVSProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MDFSJPGVSProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MDFSJPGVSProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected MDFSJPGVSProyectoIPSHelpKeywordHelperBase()
			: base() { }
